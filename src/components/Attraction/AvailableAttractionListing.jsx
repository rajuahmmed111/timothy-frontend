...
import { useGetAttractionAvailableListingsQuery } from "../../redux/api/attraction/attractionApi";

export default function AvailableAttractionListing() {
  ...
  const { data, isLoading } = useGetAttractionAvailableListingsQuery({ 
    page, 
    limit: pageSize 
  });
    ...
    <div className="p-5">
      <div className="mb-5 flex justify-end items-center">
        <div className="space-y-2 w-[400px]">
          <input
            type="text"
            placeholder="Search available attractions by type, category or location"
            value={search}
      ...
      {/* View Modal */}
      <Modal
        title="Available Attraction Details"
