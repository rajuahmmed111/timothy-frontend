...
import { useGetAttractionTotalSalesQuery } from "../../redux/api/attraction/attractionApi";
import RecentAttractionListings from "./RecentAttractionListings";
...
export default function AttractionDashboard() {
  const { data: totalSalesRes } = useGetAttractionTotalSalesQuery();
