...
import { useGetSecurityTotalSalesQuery } from "../../redux/api/security/securityApi";
import RecentSecurityListings from "./RecentSecurityListings";
...
export default function SecurityDashboard() {
  const { data: totalSalesRes } = useGetSecurityTotalSalesQuery();
