...
export default function Profile() {
  ...
  const editTabClass =
    "cursor-pointer pb-1 " +
    (activeTab === "editProfile" ? "text-[#0064D2] border-b-2 border-[#0064D2]" : "text-[#0064D2]");

  const changeTabClass =
    "cursor-pointer pb-1 " +
    (activeTab === "changePassword" ? "text-[#0064D2] border-b-2 border-[#0064D2]" : "text-[#0064D2]");

  return (
    <div className="overflow-y-auto">
      <div className="px-5 pb-5 h-full">
        <h3 className="font-bold pb-5 text-xl text-[#242424]">Profile Section</h3>
          ...
          <div className="flex justify-center items-center bg-[#0064D2] mt-5 text-white w-[900px] mx-auto p-5 gap-5 rounded-lg">
            <div className="relative">
              <div className="w-[122px] h-[122px] bg-gray-300 rounded-full border-4 border-white shadow-xl flex justify-center items-center">
                <img
                  src={profile.profileImage || "https://avatar.iran.liara.run/public/44"}
                  alt="profile"
            ...
            <div>
              <p className="text-xl md:text-3xl font-bold">{profile.fullName || "User"}</p>
