...
export default function Newsroom() {
  ...
  const HOTEL_IMG = "https://images.unsplash.com/photo-1551884170-09fb70a3a2ed";
  const CAR_IMG =
  ...
  const newsArticles = [
    {
      ...
      excerpt:
        "Expanding our network to bring you more accommodation options worldwide with exclusive deals and enhanced booking experiences.",
      date: "2024-12-15",
    ...
    },
    {
      ...
      excerpt:
        "Our latest technology update uses machine learning to provide personalized hotel recommendations based on your preferences and travel history.",
      date: "2024-12-10",
      author: "Michael Chen",
      category: "Technology",
      image: CAR_IMG,
    ...
    },
    {
      ...
      excerpt:
        "Celebrating this milestone with exclusive benefits and rewards for our loyal customers worldwide.",
      date: "2024-12-05",
    ...
    },
    {
      ...
      excerpt:
        "Introducing our new eco-friendly booking options that help offset carbon emissions for environmentally conscious travelers.",
      date: "2024-11-28",
      author: "David Park",
    ...
    },
    {
      ...
      excerpt:
        "FASIFY reports 45% year-over-year growth in hotel bookings and expansion into 15 new markets across Asia and Europe.",
      date: "2024-11-20",
      author: "Jennifer Liu",
      category: "Financial",
      image: HOTEL_IMG,
    ...
    },
    {
      ...
      excerpt:
        "Latest version includes faster booking, improved search filters, and seamless payment integration for better user experience.",
      date: "2024-11-15",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              from FASIFY. Discover our journey in revolutionizing the travel
          ...
          <div className="lg:col-span-1">
                ...
                {pressReleases.map((release, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <a
                        href={release.link}
                        className="text-[#0064D2] hover:text-[#0052A3]"
                      >
            ...
            <div className="bg-gray-100 rounded-xl p-6 mt-8">
              ...
              <div className="space-y-3">
                ...
                />
                <button className="w-full bg-[#0064D2] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#0052A3]">
                  Subscribe
                </button>
              </div>
            </div>
