        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-green-50 p-6 text-center border-b border-green-100">
            ...
            <p className="text-gray-600">
              Your event reservation has been successfully booked
            </p>
          </div>
                ...
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Experience breathtaking views from the world's tallest
                      building. Visit the observation decks on floors 124 & 125
                      for panoramic views of Dubai's skyline, desert, and
                      coastline.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-500">
                          {bookingDetails.guests || 2} guest
                          {(bookingDetails.guests || 2) > 1 ? "s" : ""}
                        </p>
                        <p className="text-sm text-gray-400">
                          Adult tickets included
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-500 font-mono">$1000</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">
                      Event Tickets ({bookingDetails.guests || 2} guests)
                    </span>
                  ...
                  <div className="flex justify-between text-sm mt-2">
                    ...
                    <span>
                      {bookingDetails.paymentMethod || "•••• •••• •••• 1234"}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
