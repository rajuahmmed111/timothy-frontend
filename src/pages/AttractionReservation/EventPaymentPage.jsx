...
import { CheckCircle, Shield, CreditCard, Lock, ArrowLeft, Calendar, MapPin, Users } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 max-w-3xl">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                        <h1 className="text-2xl font-bold text-gray-900">Complete Your Event Booking</h1>
                        <p className="text-gray-600 mt-1">Enter your payment details to confirm your event reservation</p>
                    </div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between font-medium pt-2 mt-2 border-t border-gray-200">
                                            ...
                                            <span className="text-lg">${bookingDetails.total || 650}</span>
                                        </div>
                                    </div>
                                </div>
                            )}
