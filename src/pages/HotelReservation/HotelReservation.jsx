...
export default function HotelReservation() {
  ...
  const apiParams = {
    ...
    hotelAccommodationType:
      searchParams.get("hotelAccommodationType") || undefined,
    ...
    hotelNoSmokingPreference:
      searchParams.get("hotelNoSmokingPreference") || undefined,
    ...
    hotelNoPetsPreferences:
      searchParams.get("hotelNoPetsPreferences") || undefined,
    hotelLocationFeatureWaterView:
      searchParams.get("hotelLocationFeatureWaterView") || undefined,
    hotelLocationFeatureIsland:
      searchParams.get("hotelLocationFeatureIsland") || undefined,
  };
  ...
  useEffect(() => {
    const typeFromUrl =
      new URLSearchParams(location.search).get("hotelAccommodationType") || "";
  ...
  const handleSearch = () => {
    ...
    const defChildren = 0;
    const defRooms = 1;
    if (typeof adults === "number" && adults !== defAdults)
      params.set("hotelNumAdults", String(adults));
    if (typeof children === "number" && children > defChildren)
      params.set("hotelNumChildren", String(children));
    if (typeof rooms === "number" && rooms !== defRooms)
      params.set("hotelNumberOfRooms", String(rooms));
  ...
  const total =
    Number.isFinite(totalFromApi) && totalFromApi > 0
      ...
      : hotels.length;
  const limitVal =
    Number.isFinite(currentLimit) && currentLimit > 0 ? currentLimit : 12;
  ...
  return (
    <div className="py-8 md:py-16 container mx-auto px-4">
      ...
      <div
        id="hotels-results"
        className="flex flex-col lg:flex-row gap-4 lg:gap-6 py-6 md:py-10"
      >
        {/* Filter Sidebar */}
          ...
          >
            ...
            <div>
              ...
              <Radio.Group
                ...
                onChange={(e) => {
                  ...
                  updateQueryParams({
                    hotelAccommodationType: e.target.value || "",
                  });
                }}
                className="w-full"
              >
                <div className="space-y-2">
                  ...
                  <Radio value="holiday-accommodation">
              ...
              <div className="space-y-2">
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelBreakfast", e.target.checked);
                  }}
                >
                  Breakfast included
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelKitchen", e.target.checked);
                  }}
                >
                  Kitchen
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hoitelWifi", e.target.checked);
                  }}
                >
                ...
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelParking", e.target.checked);
                  }}
                >
                ...
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelRestaurant", e.target.checked);
                  }}
                >
                ...
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelGym", e.target.checked);
                  }}
                >
                  Gym
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelPool", e.target.checked);
                  }}
                >
                  Swimming pool
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    ...
                    setBooleanParam("hotelSpa", e.target.checked);
                  }}
                >
                  Spa
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    handleFilterChange("amenities", {
                      ...filters.amenities,
                      frontDesk24: e.target.checked,
                    });
                    setBooleanParam("hotel24HourFrontDesk", e.target.checked);
                  }}
                >
                  24-hour front desk
                </Checkbox>
                <Checkbox
                  ...
                  onChange={(e) => {
                    handleFilterChange("amenities", {
                      ...filters.amenities,
                      airportShuttle: e.target.checked,
                    });
                    setBooleanParam("hotelAirportShuttle", e.target.checked);
                  }}
                >
                  Airport shuttle
                </Checkbox>
            ...
            <div>
              ...
              <Radio.Group
                ...
                onChange={(e) => {
                  handleFilterChange("preferences", {
                    ...filters.preferences,
                    smoking: e.target.value,
                  });
                  setSmokingParams(e.target.value);
                }}
                className="w-full"
              >
                <div className="space-y-2">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500 mt-1">
                {filters.reviews.minRating > 0
                  ? `${filters.reviews.minRating} stars and above`
                  : "Any rating"}
              </div>
            </div>
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5 min-h-screen md:min-h-[600px] ">
            {filteredHotels
              .slice((currentPage - 1) * limitVal, currentPage * limitVal)
              .map((hotel, index) => {
                const firstRoom = hotel?.room?.[0] || {};
                const image = hotel?.businessLogo;
                const name = hotel?.hotelName || hotel?.name || "Unnamed Hotel";
                const locationStr = `${hotel?.hotelCity || ""}${
                  hotel?.hotelCity && hotel?.hotelCountry ? ", " : ""
                }${hotel?.hotelCountry || ""}`;
                const priceNum = Number(
                  hotel?.averagePrice ?? firstRoom?.hotelRoomPriceNight ?? 0
                );
                const ratingNum = Number(
                  hotel?.averageRating ?? firstRoom?.hotelRating ?? 0
                );
                const discountPct = Number(
                  firstRoom?.discount ?? hotel?.discount ?? 0
                );
                const cardModel = {
                  id: hotel?.id,
                  image,
